...
import { AppUserDropdownMenu } from '@/components/layouts/layout-1/shared/topbar/app-user-dropdown-menu';
...
export function Header() {
  ...
  return (
    ...
    >
      <div className="container flex justify-between items-stretch lg:gap-4">
        {/* HeaderLogo */}
