...
export default function CandidateDonationsPage() {
  ...
  useEffect(() => {
    ...
    if (!candidate) {
      // No candidate assigned to this user; stop loading and show empty state
      setLoading(false);
      return;
    }
    fetchDonations();
  }, [authLoading, candidateLoading, candidate, pagination.page, pagination.per_page]);
  ...
  const fetchDonations = async () => {
    ...
    try {
      ...
      const res = await api.get(`/candidates/${candidate.id}/donations?${params}`);
