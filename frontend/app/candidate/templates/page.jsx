...
export default function CandidateTemplatesPage() {
  ...
  useEffect(() => {
    ...
    setLoading(false);
  }, [authLoading, candidateLoading, candidate]);
  ...
  const handleSave = async () => {
    if (!candidate) {
      toast.error('No candidate assigned to this account');
      return;
    }
    ...
    setSaving(true);
    try {
      await api.put(`/candidates/${candidate.id}`, { template_id: selectedTemplateId });
